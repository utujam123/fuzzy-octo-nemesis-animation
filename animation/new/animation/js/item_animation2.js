$(document).ready(function(){
			...
			// return result != null; // custom condition goes here.
				if(result.status=="success")
				{
					...
					*/
					...
					receiving_animation(result.data.item_id,result.data.sender_name);
	...
	function reset_page()
	{
		// hide all on successful receiving of items
			...
			$('#sender-placeholder').css("display", "none");
	...
	function receiving_animation(item_id, sender)
	{
		// hide all on reset of page
			$('#item-placeholder').css("display", "none");
			$('#sender-placeholder').css("display", "none");
			
		// place sender name value
			//document.getElementById('sender-placeholder').innerHTML="sent by <br />&nbsp;&nbsp;&nbsp;" +sender;
	...
	{	
		...
		// show current item
			...
			$('#item-placeholder').fadeIn("slow");
			$('#sender-placeholder').fadeIn("slow");
			/*
